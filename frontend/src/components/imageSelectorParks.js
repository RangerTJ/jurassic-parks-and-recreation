...
const ImageSelectorParks = ({preSelected, isRequired, autoFocus, setImage}) => {
  ...
  return (
    <>
      <div><label htmlFor="parksImageSelector">Image Selection</label></div>
      <select id="parksImageSelector" value={selected} onChange={selectionHandler} autoFocus={autoFocus ? true : false} required={isRequired ? true : false}>
